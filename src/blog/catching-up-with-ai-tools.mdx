---
title: "Catching up: My late adoption of LLMs as a SWE"
description: "I joined an AI company without having used LLM tools. Here's what I learned about the hype, the reality, and why adaptability matters more than early adoption."
date: '2026-01-16'
tags: ai, tools, productivity, career
---

<script>
  import LlmEffectiveness from '../lib/components/llm-effectiveness.svelte';
  import HiddenCosts from '../lib/components/hidden-costs.svelte';
  import { LLM_EFFECTIVENESS, LLM_HIDDEN_COSTS } from '../lib/static/llm-adoption.ts';
</script>

## The irony of joining an AI company

In September 2025, I joined Stack AI, a Y-Combinator startup building AI tooling
for enterprises. There is an obvious irony here that I need to address upfront: I
joined an AI company without having seriously used LLM tools in my daily work.

I had tried ChatGPT a few times. I had seen the demos. I knew the capabilities
existed. But I hadn't integrated any of it into my workflow. My editor was still
my editor, my terminal was still my terminal, and my process for building
software was largely the same as it had been for years. I was productive. I
shipped fast. Why fix what wasn't broken?

The first week at Stack AI made it clear that I was behind. Not in a dramatic,
career-threatening way, but in a quieter, more uncomfortable way. Everyone around
me used these tools as naturally as breathing. Copilot suggestions appearing mid-thought.
Claude conversations open in browser tabs. Cursor commands flying across screens.
And there I was, typing everything character by character, feeling like I had
shown up to a Formula 1 race on a bicycle.

## The skeptic's position

I want to be clear: I wasn't resisting AI tools out of principle or fear. I
wasn't worried about being replaced or philosophically opposed to the technology.
My hesitation came from a different place entirely: I had seen hype cycles before.
...
to change everything quietly fade into irrelevance. I have watched colleagues
spend weeks learning tools that were abandoned six months later. The JavaScript
ecosystem alone has taught me that not every shiny new thing deserves immediate
adoption.

My workflow worked. I had spent years refining it. I knew my editor's shortcuts
by muscle memory. I understood my build tools deeply. I could debug problems
efficiently because I understood the systems I was working with. There is real
value in that kind of deep familiarity, and I was reluctant to disrupt it for
something that might turn out to be another passing trend.

There was also the time factor. I work 40 to 60 hours per week and train 15 to
25 hours. My schedule is already optimized to the point where there is little
room for experimentation. Learning a new tool isn't free; it costs focus and
energy that I couldn't easily spare. So I watched from a distance, waiting to
see if the hype would settle into something real.
...
"10x engineers" who had unlocked superhuman productivity with AI assistants. My
LinkedIn feed showed developers claiming they had shipped entire features in
hours that would have taken days. Friends started asking me if I used Cursor,
and the pause before my answer grew more uncomfortable each time.
...
The imposter syndrome was subtle but persistent. I started questioning whether
my productivity was actually as good as I thought. Maybe I had been deluding
...
effectively. You need to understand what the model is good at and what it
struggles with. You need to develop intuition for when to trust its output and
when to verify everything manually.

I spent the first few weeks being frustrated more often than I was helped. The
AI would generate code that looked correct but had subtle bugs. It would
confidently provide outdated information. It would misunderstand my intent and
produce something completely different from what I needed. I found myself
spending significant time checking and correcting its output, which sometimes
...
that Twitter promised, but something more modest and real: maybe 20 to 30
percent faster on certain tasks, with the time savings concentrated in
specific areas.
...
and validating code that someone else wrote, except that someone is an AI.
