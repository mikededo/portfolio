...
<script>
  import StackingPreview from '../lib/components/stacking-preview.svelte';
  import IterationComparison from '../lib/components/iteration-comparison.svelte';
  import { STACK_LAYERS, ITERATIONS } from '../lib/static/stacked-dialog.ts';
</script>
