export const AboutInfoContent = [
  ...
  ``,
  `%comment TODO: Update the following line once it’s outdated!%<br/>`,
  ...
  `<br/>%class [text-yellow](&nbsp;&bull; %link [Github profile](https://github.com/mikededo)%)%`,
  `<br/>&nbsp;&bull; Open my projects with %class [text-peach](\`CTRL + p\`)%`
];
