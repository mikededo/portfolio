export const InterestContent = [
  ...
  `developing with Svelte. Since then, I've become quite attached to it, and most of my`,
  `side projects are now built with Svelte and SvelteKit.`,
  ``,
  ...
  `for TailwindCSS and Svelte %page [more on the /projects page!](/projects)%.`,
  ``,
